...
class ClassificationResult:
    ...
    version: str = "1.0.0"
    model_info: Dict[str, str] = field(default_factory=lambda: {
        "name": "classification_engine",
        "version": "1.0.0",
        "last_updated": "2025-06-23"
    })
    validation_status: str = "pending"
    quality_metrics: Dict[str, float] = field(default_factory=lambda: {
        "completeness": 0.0,
        "consistency": 0.0,
        "accuracy": 0.0
    })
...
class DocumentClassifier:
    ...
    def __init__(self):
        ...
        self.enquiry_keywords = [
            "enquiry", "inquiry", "requirement", "specification", "tender",
            "rfq", "request for quotation", "technical details", "capacity",
            "production", "manufacturing", "machinery", "equipment",
            "raw material", "application", "scope of work", "project",
            "technical specification", "machine requirement", "equipment need"
        ]

        self.quotation_keywords = [
            "quotation", "quote", "price", "cost", "amount", "payment",
            "terms", "conditions", "validity", "delivery", "tax", "gst",
            "total", "subtotal", "discount", "offer", "proposal",
            "commercial", "financial", "bank", "account", "transfer",
            "basic price", "final price"  # NEW
        ]
    ...
    def calculate_section_matches(self, found_sections: List[str], target_sections: List[str]) -> Tuple[List[str], float]:
        """
                ...
                # Keyword overlap
                    ...
                    if common_words:
                        ...
                        if overlap_score >= 0.6:
                            if target not in matched_sections:
                                matched_sections.append(target)
                            best_match_score = max(best_match_score, overlap_score * 0.6)
...
#     path_file = "/mnt/c/Users/Imran/OneDrive - Ahana Systems and Solutions (P) Ltd/Desktop/Demo/steer_document_processing_poc/demo_app/backend/utils/image/6c44bc93-7c76-47a2-a9c1-c750f228c583_TSE_Enquiry_form-Mega_80S/output_all_pages.md"
#     path_file = "/mnt/c/Users/Imran/OneDrive - Ahana Systems and Solutions (P) Ltd/Desktop/Demo/steer_document_processing_poc/demo_app/backend/utils/image/0ac8d2a5-c066-4c26-81fa-8d30f9a4713d_QU-IMM-Vi-42025-00169-1-28-04-2025-STEER_ENGGREV/output_all_pages.md"
